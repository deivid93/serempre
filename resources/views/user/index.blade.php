...
<div class="row">
    ...
    <div style="margin-left: 30px;">
        <a href="{{ route('user.new') }}" class="btn btn-success"><span style="margin-rigth:4px;" id="" class="glyphicon glyphicon-user"></span><span style="margin-left:10px;">Alta Usuarios</span></a>
                        ...
                        <form id="form" class="form-horizontal" enctype="multipart/form-data"  >
                            ...
                            <div class="row">
                                <div class="form-group mb-4">
                                    <legend class="text-center header">1.Nombre</legend>
                                ...
                                <div class="form-group mb-4">
                                    <legend class="text-center header">2.Email</legend>
                                    <div class="row">
                                        <div class="col-6 offset-3 col align-column-center" >
                                ...
                                <div class="form-group mb-4">
                                    <legend class="text-center header">3.Avatar</legend>
                                    <div class="row">
                                        <div class="col-6 offset-3 col align-column-center" >
                                            <input required id="avatar" name="avatar" type="file" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                ...
                <table id="city" class="table table-striped table-bordered bulk_action dt-responsive nowrap"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="avatar" data-formatter="avatar" data-sortable="true" data-filter-control="select">Avatar</th>
...
@section('js')
  <script type="text/javascript">
    ...
    function avatar(value, row, index){

        const url = "{{asset('storage')}}"+"/"+row.avatar
        return [
    ...
    window.operateEvents = {
        'click .edit': function(e, value,row, index){
            ...
            $("#form").on('submit', function(e){
               e.preventDefault()
               $.post('{{route('user.update')}}',$("#form").serialize(), function (res){
